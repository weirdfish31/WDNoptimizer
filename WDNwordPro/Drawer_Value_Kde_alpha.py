...
#sns.jointplot('sapps','value',data=memoryset.probmemoryunit, kind='reg')      
sns.kdeplot(memoryset.probmemoryunit.sapps,memoryset.probmemoryunit.value,shade=True,cbar=True)  
#==============================================================================                 
