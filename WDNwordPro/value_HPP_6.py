...
"""
ttt=valuegmmgamer.valueUCBhelper_state(memoryset.probmemoryunit,kappa=5,iternum=25,count=0)
tu=ttt.tolist()
listaaa.append(tu)
...
# =============================================================================
    ...
    newdata=teaser.updatetrainningsetworker_state(state,path=newdatapath,count=10,style='value')
...
#    distriubuteculsterdata=distriubuteculsterdata.append(newdataset)
    ...
    ttt=valuegmmgamer.valueUCBhelper_state(memoryset.probmemoryunit,kappa=5,iternum=100,count=simucount)
    tu=ttt.tolist()
    listaaa.append(tu)
