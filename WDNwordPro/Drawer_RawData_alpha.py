...
figpath="./Figure/"
datapath='E:/WDNoptimizer/GPR_k5_i60/'
...
dataset="radio REQUEST-SIZE DET 18914 _ 24000 _ RND DET 36955 _0"
...
readdb.inputparainsert(20,18914,30,24000,30,36955)
#将每条流的业务设计参数加入类中的字典

#===================================================以上步骤不可省略，下方处理可以根据需求修改
a=readdb.flowaggregator(20,18914,30,24000,30,36955)
#将同一个源到目的业务数据聚合在一起输出一个dataframe，一个数据库生成一个流聚合frame
flowdata=flowdata.append(a)
b=readdb.alltypeaggregator(20,18914,30,24000,30,36955,'trafficgen')
