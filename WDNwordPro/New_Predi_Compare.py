# -*- coding: utf-8 -*-
"""
Created on Tue Nov 13 09:26:19 2018

@author: WDN
predictcompare文件
针对迭代之后的预测值与实际仿真值与真实指标值之间的相互比较
"""
import pandas as pd
import numpy as np
...
figpath="./Figure/"
GPRpath="D:/1cluster_3times_GPR/"
GMMpath="D:/2cluster_10times_GMM"
xmin,xmax=0,65000
ymin,ymax=0,65000
...
for i in listaaaGMM:
    "先根据目前的querypoint进行木星上的预测，报货两簇的均值，然后按大小来排列"
    ttt=np.array([i])
